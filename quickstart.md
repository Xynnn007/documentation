...
## Building a new encrypted container image and deploying it as a CoCo workload
 ...
 - [Use EAA KBC and Verdictd (TDX)](./guides/eaa_kbc_and_verdictd_on_tdx.md)

 - [Use offline SEV KBC and simple-kbs (SEV)](./guides/offline_sevkbc_and_simple_kbs_on_sev.md)

 - [Use CC KBC and generic KBS (TDX)](./guides/cc_kbc_and_generic_kbs_on_tdx.md)
